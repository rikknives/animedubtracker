...
for line in lines:
 ...
 elif '(Episodes:' in line or '(Episode' in line:
 html_parts.append(f'<div class="anime"><span>{line.split("(Episode")[0].strip()}</span><span class="ep">{line.split("(Episode")[-1].replace(")","")}</span></div>')
